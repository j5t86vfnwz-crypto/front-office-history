...
def main():
    ...
    opening=[1,4,33,35,64,65,101,123,138,159,175,219]
    draft_rows=[{'season':'2018','pick':str(p),'team':'MIA'} for p in opening]
    draft_rows.append({'season':'2018','pick':'188','team':'CLE'})
    owners=b.opening_pick_owners(draft_rows,[],2018)
    assert all(owners[p]=='CLE' for p in opening) and owners[188]=='WAS'
